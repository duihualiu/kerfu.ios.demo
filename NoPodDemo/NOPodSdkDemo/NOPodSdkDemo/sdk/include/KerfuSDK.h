...
#import "KFSpeechRecognizer.h"
#import "KFSpeechRecognizerDelegate.h"
#import "KFDialogManager.h"
#import "KFDynamicEntity.h"

@interface KerfuSDK : NSObject
 ...
 */
+ (void)addDynamicEntities:(NSArray<KFDynamicEntity *> *)entities;

...
#import "KFSpeechRecognizerDelegate.h"

@interface KFSpeechRecognizer : NSObject

/*!
 *  设置委托对象
 */
@property(nonatomic,weak) id<KFSpeechRecognizerDelegate> delegate;

/**
 初始化方法，需传入delegate对象以监听状态及返回
 */
- (instancetype)initWithDelegate:(id<KFSpeechRecognizerDelegate>)delegate;
